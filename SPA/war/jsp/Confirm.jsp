...
<table>
<tr> <td colspan="2"> Enter Your Password </td> <td colspan="2"> <input type="password" name="password" id="password"  placeholder="Enter Password"></td><td> <span  style="color:red" id='p'></span></td></tr>
