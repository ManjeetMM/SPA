...
<tr><td colspan="2" style="font-weight:bold;">Email:</td><td> <input type="text" name ="email" id="email" onblur="myFu()" onfocus="focusFunction()" ng-model="email"  placeholder="Enter email"> </td> <td colspan="2"> <span id="eml" style="color:red"></span></td></tr>
<tr><td colspan="2" style="font-weight:bold;">Password:</td><td> <input type="password" name ="password" id="password" onblur="myFu2()"  onfocus="focusFunction2()"ng-model="password" placeholder="Enter password"> </td> <td colspan="2"> <span id="psw" style="color:red" ></span> </td> </tr>
...
angular.module("Login",[]).controller("ExampleCtrl",function($scope,$http){
	...
	if($scope.email && $scope.password)
	 ...
	 resp.success(function(data, status, headers, config){
		...
		//document.location.assign("/jsp/Template.jsp");
